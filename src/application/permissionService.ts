...
import { ForbiddenError, NotFoundError, ValidationError } from "../domain/exceptions";
import { AuthContext, DocumentPermission } from "../domain/models";
import { DocumentRepository, PermissionRepository } from "../domain/ports";
